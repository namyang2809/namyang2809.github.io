const textConfig = {
  ...
  text12: "Click to end this service and begin a new date ^^",
};
...
$(document).ready(function () {
  ...
  $("#yes").click(function () {
    ...
    Swal.fire({
      ...
      width: 900,
      padding: "3em",
      html: "<input type='text' class='form-control' id='txtReason'  placeholder='Fill Here'>",
      background: '#fff url("img/iput-bg.jpg")',
      backdrop: `
                    rgba(0,0,123,0.4)
                    url("img/bearr.gif")
      ...
      if (result.value) {
        Swal.fire({
          ...
          onClose: () => {
            window.location = "https://www.instagram.com/odaycomemecuauyvyneee/";
          },
        });
      }
    });
